...
function( common_compiler_flags TARGET_NAME )
    ...
    target_compile_options( ${TARGET_NAME}
        ...
        # MSVC only
        $<${IS_MSVC}:
            # The CMake -j, --parallel only signals to MSBuild to compile concurrent targets,
            # but it doesnt spawn multiple processes per file.
            # /MP Build with multiple processes, implies /FS
            /MP${PROC_N}
