...
function( godotcpp_generate )
    ...
    foreach ( TARGET_ALIAS template_debug template_release editor )
        ...
        string( JOIN "" GODOT_SUFFIX
                ...
                "$<1:.${SYSTEM_ARCH}>"
                # TODO missing IOS_SIMULATOR
                # TODO missing THREADS
        )
        ...
        #[[ While file globbing is typically discouraged, in this case we are matching SCons ]]
        ...
        if( DEBUG_CMAKE )
            include( ${CMAKE_CURRENT_SOURCE_DIR}/cmake/genex_debug.cmake)
        endif(  )
    endforeach ()

    #[[ Added for backwards compatibility with prior cmake solution so that
    builds dont immediately break from a missing target.]]
